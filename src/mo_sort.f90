...
MODULE mo_sort
  ...
  !   integer*4, dimension(size(arr)) :: ii
  !   ii = sort_index(arr)
  !   arr = arr(ii)
  ...
  !     RETURNS
  !>       \return integer*4 :: indices(:) &mdash; Indices that would sort arr in ascending order
...
CONTAINS
  ...
  FUNCTION arth_r(first,increment,n)
    REAL*4, INTENT(IN) :: first,increment
    INTEGER*4, INTENT(IN) :: n
    REAL*4, DIMENSION(n) :: arth_r
    INTEGER*4 :: k,k2
    REAL*4 :: temp
  ...
  SUBROUTINE icomp_xchg_i4(arr, i, j)
    ...
    INTEGER*4, DIMENSION(:), INTENT(IN)    :: arr
...
! ------------------------------------------------------------------
  ...
  SUBROUTINE sort_i4(arr)
    ...
    INTEGER*4, PARAMETER :: NN=15
    INTEGER*4, PARAMETER :: NSTACK=50
    INTEGER*4 :: a
    INTEGER*4 :: n, k, i, j, jstack, l, r
    INTEGER*4, DIMENSION(NSTACK) :: istack
  ...
  FUNCTION sort_index_sp(arr)
    ...
    REAL*4,    DIMENSION(:), INTENT(IN) :: arr
    INTEGER*4, DIMENSION(size(arr))     :: sort_index_sp

    INTEGER*4, PARAMETER :: NN=15
    INTEGER*4, PARAMETER :: NSTACK=50
    REAL*4    :: a
    INTEGER*4 :: n, k, i, j, indext, jstack, l, r
    INTEGER*4, DIMENSION(NSTACK) :: istack
  ...
  FUNCTION sort_index_dp(arr)
    ...
    REAL*8,    DIMENSION(:), INTENT(IN) :: arr
    INTEGER*4, DIMENSION(size(arr))     :: sort_index_dp
  ...
  FUNCTION sort_index_i4(iarr)
    ...
    INTEGER*4, DIMENSION(:), INTENT(IN) :: iarr
    INTEGER*4, DIMENSION(size(iarr))    :: sort_index_i4
  ...
  !   INTEGER*4, DIMENSION(:), INTENT(INOUT) :: a,b
  !   INTEGER*4, DIMENSION(SIZE(a)) :: dum
  !   dum=a
  !   a=b
  !   b=dum
  ...
  !   INTEGER*4, DIMENSION(:,:), INTENT(INOUT) :: a,b
  !   INTEGER*4, DIMENSION(size(a,1),size(a,2)) :: dum
  !   dum=a
  !   a=b
  !   b=dum
  ...
  !   REAL*4, DIMENSION(:,:), INTENT(INOUT) :: a,b
  !   REAL*4, DIMENSION(size(a,1),size(a,2)) :: dum
  !   dum=a
  !   a=b
  !   b=dum
  ...
  !   REAL*8, DIMENSION(:,:), INTENT(INOUT) :: a,b
  !   REAL*8, DIMENSION(size(a,1),size(a,2)) :: dum
  !   dum=a
  !   a=b
  !   b=dum
  ...
  !   INTEGER*4, DIMENSION(size(a)) :: swp
  !   where (mask)
  !      swp=a
  !      a=b
  !      b=swp
  ...
  !   INTEGER*4, DIMENSION(:,:), INTENT(INOUT) :: a,b
  !   LOGICAL, DIMENSION(:,:), INTENT(IN) :: mask
  !   INTEGER*4, DIMENSION(size(a,1),size(a,2)) :: swp
  !   where (mask)
  !      swp=a
  !      a=b
  !      b=swp
  ...
  !   REAL*4, DIMENSION(:,:), INTENT(INOUT) :: a,b
  !   LOGICAL, DIMENSION(:,:), INTENT(IN) :: mask
  !   REAL*4, DIMENSION(size(a,1),size(a,2)) :: swp
  !   where (mask)
  !      swp=a
  !      a=b
  !      b=swp
